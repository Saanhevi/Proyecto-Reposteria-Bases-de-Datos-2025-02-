...
<head>
    ...
    <title>Crear Cajero - Repostería</title>
        ...
        <div class="main-content">
            ...
            <div class="header">
                <div class="header-info">
                    <div class="header-title">Crear Cajero</div>
                    <div class="header-subtitle">Ingrese los datos del nuevo cajero</div>
                </div>
            ...
            <div class="main-content-form">
                <div class="form-container">
                    <form action="{{ route('admin.cajeros.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="caj_turno" id="caj_turno" class="form-input" required>
                                ...
                                <option value="Mañana" {{ old('caj_turno') == 'Mañana' ? 'selected' : '' }}>Mañana</option>
                                <option value="Tarde" {{ old('caj_turno') == 'Tarde' ? 'selected' : '' }}>Tarde</option>
                                <option value="Noche" {{ old('caj_turno') == 'Noche' ? 'selected' : '' }}>Noche</option>
                            </select>
                            @error('caj_turno')
                                <p class="error-message">{{ $message }}</p>
                            @enderror
