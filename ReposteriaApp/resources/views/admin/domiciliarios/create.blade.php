...
<head>
    ...
    <title>Crear Domiciliario - Repostería</title>
        ...
        <div class="main-content">
            ...
            <div class="header">
                <div class="header-info">
                    <div class="header-title">Crear Domiciliario</div>
                    <div class="header-subtitle">Ingrese los datos del nuevo domiciliario</div>
                </div>
                <div class="header-actions">
                </div>
            </div>
            
            <!-- Create Domiciliario Form -->
            <div class="main-content-form">
                <div class="form-container">
                    <form action="{{ route('admin.domiciliarios.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="dom_medTrans" id="dom_medTrans" class="form-input">
                                ...
                                <option value="Bicicleta" {{ old('dom_medTrans') == 'Bicicleta' ? 'selected' : '' }}>Bicicleta</option>
                                <option value="Moto" {{ old('dom_medTrans') == 'Moto' ? 'selected' : '' }}>Moto</option>
                            </select>
                            @error('dom_medTrans')
                                <p class="error-message">{{ $message }}</p>
                            @enderror
