...
-- =============================================================
--  Procedimientos almacenados con manejo de transacciones
--  Cada bloque de escritura incluye:
--    - Manejador de excepciones para hacer ROLLBACK y reenviar el error
--    - START TRANSACTION / COMMIT para garantizar atomicidad
--  Ejecutar despues de crear el esquema y las tablas.
-- =============================================================
